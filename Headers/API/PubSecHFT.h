...
/* Entries in the certificate's Identification cab*/
#define PROP_CertIdentification					"Identification"
#define PROP_CountryID							"Country"		/* Text: country ISO 3166 code */
#define PROP_SourceID							"Source"		/* Text: source of the certificate (AATL/EUTL,etc.) */
#define PROP_EnabledID							"Enabled"		/* Boolean: if "false" do not use this certificate in chain building */
#define PROP_VisibleID							"Viewable"		/* Boolean: if "false" do not show Identity in the UI */
...
#define GetCertValidityPV (*((GetCertValidityPV_SELPROTO)(gPubSecHFT[GetCertValidityPV_SEL])))
