...
PIPROC(ASUns64, DigSigOverwriteBytes64, 
	...
	@param pdAnnot IN  The annotation the user clicked on or tabbed into.
	@param avPV IN  The page view that contains the annotation.
	@param bIsSelected IN  <code>true</code> if the annotation is selected, <code>false</code> otherwise.
	@see DigSigHexToByte
	@see DigSigRightClick
	*/
	PIPROC(void, DigSigPostDraw,
	(PDAnnot pdAnnot, AVPageView avPV, ASBool bIsSelected), pdAnnot, avPV, bIsSelected)
