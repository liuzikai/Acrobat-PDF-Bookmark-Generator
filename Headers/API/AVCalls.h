...
#define AVAppRegisterIdleProcOLD AVROUTINE(AcroViewHFT_VERSION_2, AVAppRegisterIdleProcOLD)
#else
...
#define AVAppRegisterLateInitProcOLD AVROUTINE(AcroViewHFT_VERSION_7, AVAppRegisterLateInitProc)
#else
#define AVAppRegisterLateInitProc AVROUTINE(AcroViewHFT_VERSION_7, AVAppRegisterLateInitProc)
#endif // #if USE_NAMED_LATE_INIT_PROCS
...
/* AVAppRegisterIdleProc */
#define AVAppRegisterIdleProcWithName AVROUTINE(AcroViewHFT_VERSION_11_6, AVAppRegisterIdleProcWithName)

#define AVAppRegisterLateInitProcWithName AVROUTINE(AcroViewHFT_VERSION_11_6, AVAppRegisterIdleProcWithName)

#define AVAppUnregisterForContextMenuAddition AVROUTINE(AcroViewHFT_VERSION_12, AVAppUnregisterForContextMenuAddition);

#define AVAppSaveDialogEx AVROUTINE(AcroViewHFT_VERSION_12, AVAppSaveDialogEx)

#define AVAppBeginSaveEx AVROUTINE(AcroViewHFT_VERSION_12, AVAppBeginSaveEx)

#define AVAppRegisterIdleProcExWithName AVROUTINE(AcroViewHFT_VERSION_12, AVAppRegisterIdleProcExWithName)

#define AVAppGetVersionEx AVROUTINE(AcroViewHFT_VERSION_12, AVAppGetVersionEx)

#define AVExtensionAcquireInfoEx AVROUTINE(AcroViewHFT_VERSION_12_3, AVExtensionAcquireInfoEx)

#define AVExtensionReleaseInfoEx AVROUTINE(AcroViewHFT_VERSION_12_3, AVExtensionReleaseInfoEx)

#define AVDocBringToFront AVROUTINE(AcroViewHFT_VERSION_12_3, AVDocBringToFront)

#define AVDocGetDisplayTitle AVROUTINE(AcroViewHFT_VERSION_12_3, AVDocGetDisplayTitle)

#define AVIconCreateFromPDF AVROUTINE(AcroViewHFT_VERSION_12_3, AVIconCreateFromPDF)

#define AVToolBarSetIcon AVROUTINE(AcroViewHFT_VERSION_12_3, AVToolBarSetIcon)
